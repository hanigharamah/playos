...
export default function RefundPolicy() {
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      ...
      <p className="text-muted-foreground mb-8 text-sm">Last updated: July 2026</p>
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-4">
          <div className="flex items-start justify-between gap-4 pb-4 border-b">
            <div>
              <div className="font-semibold">More than 26 hours before kickoff</div>
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              <div className="font-semibold">26 hours or less before kickoff</div>
              <div className="text-sm text-muted-foreground">No refund. Your spot is released so someone else can take it.</div>
            </div>
      ...
      <Card className="mb-6">
        ...
        <CardContent className="text-sm text-muted-foreground space-y-3">
          <p>
            Cancellations are handled in the app. Full refunds are returned via your original payment method (STC Pay or cash).
          </p>
          <p>
            This 26-hour cutoff is shown on the booking screen before you pay, so you always know the terms before confirming.
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <ul className="list-disc list-inside space-y-1.5 text-sm text-muted-foreground">
            ...
            <li>The player cancels within the eligible time window (more than 26 hours before kickoff)</li>
          </ul>
        </CardContent>
      </Card>
    </div>
