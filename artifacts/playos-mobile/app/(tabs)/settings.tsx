...
export default function Profile() {
  ...
  const menu = [
    { icon: <UserIcon size={22} color={INK} strokeWidth={1.8} />, label: "personal info", onPress: () => {} },
    { icon: <CreditCard size={22} color={INK} strokeWidth={1.8} />, label: "payment methods", onPress: () => {} },
