    ...
    <div className="max-w-2xl mx-auto px-4 py-12">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <div className="text-sm text-muted-foreground">No refund available. Your spot is released for other players.</div>
            </div>
      ...
      <Card className="mb-6">
        ...
        <CardContent className="text-sm text-muted-foreground space-y-3">
          ...
          <p>
            If no refund is applicable (26 hours or less before kickoff), this is shown clearly before you confirm a cancellation.
          </p>
        </CardContent>
      </Card>
