        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
          ...
          <div className="col-span-2 md:col-span-2">
            <div className="flex items-center mb-3">
              ...
              <span className="text-xl font-extrabold uppercase" style={{ background: "linear-gradient(120deg, #FFBE9D 0%, #FF9DBB 45%, #C79BF0 100%)", WebkitBackgroundClip: "text", backgroundClip: "text", color: "transparent", letterSpacing: "-0.03em" }}>OS</span>
            </div>
